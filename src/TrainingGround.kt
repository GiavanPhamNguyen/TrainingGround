...
fun attackFists(){//declare functions for attacking with fists
    val hitChance = (2..12).random()
    val damageChance = (1..6).random()
    if (hitChance <= 3){
